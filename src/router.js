...
const router = new Router({
  ...
  routes: [
    ...
    {
      path: "/admin",
      component: () => import("@/layouts/admin-layout/Layout.vue"),
      children: [
        {
          name: "Dashboard",
          path: "dashboard",
        ...
        },
        {
          name: "Oprator",
          path: "oprator",
          component: () => import("@/views/admin/oprator/Oprator.vue"),
          props: true,
          meta: {
            requiresAuth: true
          },
        },
        {
          name: "Barang",
          path: "barang",
          component: () => import("@/views/admin/barang/Barang.vue"),
          props: true,
          meta: {
            requiresAuth: true
          },
        },
        {
          name: "DetailBarang",
          path: "barang/detail",
          component: () => import("@/views/admin/barang/DetailBarang.vue"),
          props: true,
          meta: {
            requiresAuth: true
          },
        },
        {
          name: "Sopir",
          path: "sopir",
          component: () => import("@/views/admin/sopir/Sopir.vue"),
          props: true,
          meta: {
            requiresAuth: true
          },
      ...
      children: [
        {
          ...
          path: "dashboard",
          component: () => import("@/views/oprator/dashboard/Index.vue"),
          props: true,
          meta: {
            requiresAuth: true
          },
